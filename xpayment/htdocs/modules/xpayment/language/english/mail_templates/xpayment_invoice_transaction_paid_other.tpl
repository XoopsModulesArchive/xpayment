...
<p>This is a notice that a paid invoice on {SITENAME} has had a transaction passed againt it and is on "<span style='color: #b20000'>other</span>" for a transaction type.</p>
